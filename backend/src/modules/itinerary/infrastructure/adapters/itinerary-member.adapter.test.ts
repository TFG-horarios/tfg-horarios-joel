...
import { ItineraryMemberAdapter } from './itinerary-member.adapter';

describe('ItineraryMemberAdapter', () => {
  ...
  const adapter = new ItineraryMemberAdapter(memberRepositoryMock);
