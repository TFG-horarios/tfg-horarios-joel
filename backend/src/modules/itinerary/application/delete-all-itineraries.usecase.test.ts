...
import { DeleteAllItinerariesUseCase } from './delete-all-itineraries.usecase';
import { ForbiddenError } from '@/core/errors/app.error';

describe('DeleteAllItinerariesUseCase', () => {
  ...
  const useCase = new DeleteAllItinerariesUseCase(
    repositoryMock,
    memberProviderMock
  );
  ...
  test('should delete all itineraries successfully if user has permission', async () => {
