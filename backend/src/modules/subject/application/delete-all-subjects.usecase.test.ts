...
import { DeleteAllSubjectsUseCase } from './delete-all-subjects.usecase';
import { ForbiddenError } from '@/core/errors/app.error';

describe('DeleteAllSubjectsUseCase', () => {
  ...
  const useCase = new DeleteAllSubjectsUseCase(
    repositoryMock,
    memberProviderMock
  );
  ...
  test('should delete all subjects successfully if user has permission', async () => {
