...
export interface ClassroomConfigurationDTO {
  classroomId: string;
  academicYear: string;
...
export interface ClassroomConfigurationCardProps {
  item: ClassroomConfigurationDTO;
  classroomMap: Map<string, string>;
  organizationId: string;
  translations?: Record<string, string>;
}

export const ClassroomConfigurationCard = memo(
  function ClassroomConfigurationCard({
    item: config,
    classroomMap,
    organizationId,
    translations = {},
